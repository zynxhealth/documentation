...
| identifier  | Returns content / Plan Definition for given contentId | N\A | No | Zynx contentIds |```\?identifier=http://www.zynxhealth.com/codings/id/zynx/ contentid%7C<AuthorSpace contentId>``` Trial Order Set 795 example: ```\?identifier=http://www.zynxhealth.com/codings/id/zynx/ contentid%7C795``` | 
